...
namespace CalculoDeRisco.REGULAMENTAR
{
    ...
    public class ForeignExchangeRiskCalculation
    {
        ...
        {
            double foreignExchangeExposureFactor = GetForeignExchangeExposureFactor(minExcessForeignExchangeFactor, minBetweenNetForeignExchangeFactor, patrimoniodeReferencia);
            ...
            double capitalRequirement = foreignExchangeExposureFactor * foreignExchangeExposure;
        ...
        private static double GetMinBetweenNetForeignExchangeExposure(List<Exposure> exposures)
        {
            ...
            Dictionary<(int CurrencyId, int LocationId), double> groupedExposures = new Dictionary<(int CurrencyId, int LocationId), double>();
        ...
        private static double GetForeignExchangeExposureFactor(List<Exposure> exposures, double minExcessForeignExchangeFactor, double minBetweenNetForeignExchangeFactor, double patrimoniodeReferencia)
        {
